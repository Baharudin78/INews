...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigation.findNavController().addOnDestinationChangedListener { _, destination, _ ->
            when(destination.id) {
                R.id.entertainmentFragment, R.id.businessFragment,R.id.scienceFragment,R.id.sportFragment,R.id.technologyFragment,R.id.healthFragment , R.id.detailFragment->
